    ...
    @endif
        ...
        <div class="form-label" id="v-pills-tabContent" style="margin-left: 200px; width: calc(100% - 200px);">
            <div class="tab-pane fade show active" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                <h3 class="mt-3 mb-3">List Dokumen Saya</h3>
            ...
            <div class="table-responsive" style="width: calc(100% - 220px);">
        ...
        <tbody id="documentTableBody">
            ...
            @foreach($documents as $index => $document)
                @php
                    ...
                    $showDocument = $document->created_by === $currentUser->name;
                @endphp
                ...
                @if($showDocument)
                    <tr data-category="{{ $document->kategori_dokumen }}">
                        ...
                        <td>{{ $document->tags }}</td>
                        <td>
                            <a href="{{ route('dokumen.edit', $document->id) }}" class="btn btn-link p-0" style="margin-right: 0.3rem;">
                                <i class="fa fa-edit" aria-hidden="true" style="color: blue;"></i>
                            </a>
                            <a href="{{ asset('storage/documents/' . $document->dokumen_file) }}" class="btn btn-link p-0" style="margin-right: 0.3rem;" download>
                                <i class="fa fa-download"></i>
                            </a>
                            <a href="{{ route('dokumen.history', $document->id) }}" class="btn btn-link p-0" style="margin-right: 0.3rem;">
